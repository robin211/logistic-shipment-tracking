...
public abstract class Hilt_BaseFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  public final Object generatedComponent() {
    return UnsafeCasts.<Hilt_BaseFragment>unsafeCast(this).componentManager().generatedComponent();
  }
  ...
  protected void inject() {
    ((BaseFragment_GeneratedInjector) UnsafeCasts.<Hilt_BaseFragment>unsafeCast(this).generatedComponent()).injectBaseFragment(UnsafeCasts.<BaseFragment>unsafeCast(this));
  }
